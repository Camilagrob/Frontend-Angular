...
@Component({
  selector: 'app-banner-photo-modal',
  templateUrl: './banner-photo-modal.component.html',
  styleUrls: ['./banner-photo-modal.component.css']
})
export class BannerPhotoModalComponent implements OnInit {
